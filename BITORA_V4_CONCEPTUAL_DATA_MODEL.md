...
flowchart TD
  ...
  EligibilityDecision --> CertificateIssuance["Certificate Issuance"]
  CertificateType["Certificate Type"] --> CertificateTemplate["Certificate Template"]
  CertificateTemplate --> CertificateTemplateVersion["Certificate Template Version"]
  CertificateTemplateVersion --> CertificateIssuance
  CertificateIssuance --> CertificateDocument["Certificate Document"]
  CertificateIssuance --> CertificateVerification["Certificate Verification"]
  CertificateIssuance --> CertificateRevocation["Certificate Revocation"]
  CertificateIssuance --> CertificateReissuance["Certificate Reissuance"]
  Event --> Survey["Survey"]
