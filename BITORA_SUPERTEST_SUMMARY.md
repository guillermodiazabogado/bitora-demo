...
- PASSED `integridad` (9.41s)
- PASSED `convivencia` (9.23s)
- PASSED `email_productivo` (0.84s)
- PASSED `whatsapp_productivo` (0.93s)
- PASSED `event_restore` (0.6s)
- PASSED `storage_event_backup_restore` (0.52s)
- PASSED `demo_live_10` (1.03s)
- PASSED `postgres_static` (0.51s)
- PASSED `production_postgres` (0.46s)
- PASSED `comunicaciones_permisos` (6.19s)
- PASSED `usuarios_eventos` (5.86s)
- PASSED `seguridad_basica` (10.77s)
- PASSED `datos_basura` (6.18s)
- PASSED `errores_humanos` (6.22s)
- PASSED `concurrencia_critica` (10.01s)
- PASSED `multievent_isolation_20_events` (10.1s)
- PASSED `multitenant_integrations` (0.86s)
- PASSED `google_oauth_http_flow` (0.64s)
- PASSED `google_oauth_state_security` (0.87s)
- PASSED `google_oauth_multitenant_isolation` (0.86s)
- PASSED `google_oauth_refresh_contract` (0.64s)
- PASSED `google_oauth_backup_restore` (0.85s)
- PASSED `google_oauth_multitenant_live` (6.78s)
- PASSED `email_multitenant_live` (7.1s)
- PASSED `whatsapp_multitenant_live` (11.79s)
- PASSED `webhooks_multitenant_live` (13.19s)
- PASSED `backup_multitenant_live` (0.66s)
- PASSED `restore_multitenant_live` (0.65s)
- PASSED `integrations_disaster_recovery` (0.86s)
