...
- OMITTED `backup_multitenant`: Pendiente extender backup completo con varias organizaciones.
- OMITTED `restore_multitenant`: Pendiente prueba live de restauracion multiorganizacion.
